...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.tracklist_input = QtWidgets.QTextEdit(Dialog)
        self.tracklist_input.setGeometry(QtCore.QRect(440, 100, 421, 631))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.tracklist_input.setFont(font)
        self.tracklist_input.setObjectName("tracklist_input")
        self.tracklist_input.setText('Paste Tracklist from 1001 Tracklists Here')
        ...
        self.tracklist_label.setGeometry(QtCore.QRect(440, 70, 111, 31))
        font = QtGui.QFont()
        ...
        self.get_file.setGeometry(QtCore.QRect(130, 100, 151, 71))
        font = QtGui.QFont()
        ...
        self.file_path.setGeometry(QtCore.QRect(80, 190, 256, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.output_update.setGeometry(QtCore.QRect(40, 450, 381, 281))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.output_label.setGeometry(QtCore.QRect(100, 295, 256, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.output_label.setFont(font)
        self.output_label.setObjectName("output_label")

        self.output_dir = QtWidgets.QTextBrowser(Dialog)
        self.output_dir.setGeometry(QtCore.QRect(80, 350, 256, 61))
        font = QtGui.QFont()
        font.setPointSize(12)
